...
namespace ORB {
    ...
    ORBFeature::DistributeQuadtree(const std::vector<cv::KeyPoint> &vToDistributeKeys, const int &minX,
    ...
    void ORBFeature::computeOrientation(const cv::Mat &image, std::vector<cv::KeyPoint> &keypoints,
    ...
    void ORBFeature::computeOrbDescriptor(const cv::KeyPoint &kpt, const cv::Mat &img, const cv::Point *pattern,
                                          uchar *desc) {
